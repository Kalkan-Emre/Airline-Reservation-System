...
private: // YOU MAY ADD YOUR OWN UTILITY MEMBER FUNCTIONS HERE.
    void searchFlight_helper(BSTNode<Flight>* r, const std::string &departureCity, const std::string &arrivalCity, std::vector<Flight *> &v);
    Flight * searchFlight_helper2(BSTNode<Flight>* r, const std::string &flightCode);
